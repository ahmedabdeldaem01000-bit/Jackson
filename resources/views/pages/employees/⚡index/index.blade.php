 <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">الوظفين</h1>
            <p class="mt-2 text-sm text-gray-700">
              قائمة بجميع الموظفين، تتضمن أسماءهم وهواتفهم , بريدهم الإلكتروني  وحالاتهم.
    ...
    <div class="mt-8 flex flex-col md:flex-row gap-4">
        {{-- Search --}}
        <div class="flex-1">
            <input wire:model.live.debounce.300ms="search" type="text" placeholder="ابحث عن موظف..."
        ...
        <div class="w-full md:w-40">
            <select wire:model.live="status"
                ...
                <option value="">حاله الموظف</option>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class=" text-left  py-3.5 pl-3 pr-4 sm:pr-6">
